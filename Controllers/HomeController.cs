...
namespace WebAppluisChaves.Controllers
{
    public class HomeController : Controller
    {
        ...
        private readonly billing_luis_chavesContext billingContext;

        public HomeController(ILogger<HomeController> logger, billing_luis_chavesContext billingContext)
        {
            _logger = logger;
